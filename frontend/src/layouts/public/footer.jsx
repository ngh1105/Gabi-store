                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-5">
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Vá» E-Shop</h2>
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <Link
                                            ...
                                            to="/contact"
                                            className="hover:underline">LiÃªn há»‡</Link>
                                    </li>
                                    <li>
                                        <Link
                                            onClick={() => {
                                            ...
                                            to="/about"
                                            className="hover:underline">Giá»›i thiá»‡u</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">ThÆ°Æ¡ng hiá»‡u</h2>
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    {
                            ...
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Danh má»¥c</h2>
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    {
                            ...
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Theo dÃµi</h2>
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://www.facebook.com/E-Shopee" className="hover:underline ">Facebook</a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">ChÃ­nh sÃ¡ch</h2>
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <Link
                                            onClick={() => {
                                            ...
                                            to="/policy" className="hover:underline">ChÃ­nh sÃ¡ch báº£o máº­t</Link>
                                    </li>
                                    <li>
                                        <Link
                                            onClick={() => {
                                            ...
                                            to="/terms" className="hover:underline">Äiá»u khoáº£n sá»­ dá»¥ng</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Â© 2023 <a href="https://flowbite.com/" className="hover:underline">E-Shopâ„¢</a>. Táº¥t cáº£ cÃ¡c quyá»n Ä‘Æ°á»£c báº£o lÆ°u.
                        </span>
                        <div className="flex mt-4 gap-2 sm:justify-center sm:mt-0">
                            <a href="https://www.facebook.com/E-Shopee" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
