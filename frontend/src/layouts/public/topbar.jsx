            ...
            <nav className="bg-white border-b border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        <img src="https://cdn-icons-png.flaticon.com/512/3081/3081559.png" className="mr-3 h-6 sm:h-9" alt="Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">E-Shop</span>
                    </Link>
                                ...
                                : (
                                    <>
                                        <div className="flex items-center lg:order-2">
                                            ...
                                            {/* Love */}
                                            <Link to="/wishlist">
                                                <button className="p-2 mr-1 rounded-lg text-gray-500 hover:text-gray-900 hover:bg-gray-100 hover:ring-4 hover:ring-gray-300">
                    ...
                    >
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            {
                                tabs.map((obj, index) => {
                                    const activeClass = "uppercase block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0";
                                    const inactiveClass = "uppercase block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0";
