...
export default function ForgotPasswordPage() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            setStatus(prevState => ({
                ...
                isError: false,
                isSuccess: true,
                successMessage: "Má»™t email xÃ¡c nháº­n Ä‘Ã£ Ä‘Æ°á»£c gá»­i Ä‘áº¿n hÃ²m thÆ° cá»§a báº¡n. Vui lÃ²ng kiá»ƒm tra hÃ²m thÆ° Ä‘áº¿n vÃ  thá»±c hiá»‡n theo hÆ°á»›ng dáº«n trong email Ä‘á»ƒ hoÃ n táº¥t quÃ¡ trÃ¬nh."
            }));
    ...
    return (
        <PageLayout title="QuÃªn máº­t kháº©u">
