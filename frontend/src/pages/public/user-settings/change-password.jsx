    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            confirmPassword: Yup.string()
                .required("ÄÃ¢y lÃ  dá»¯ liá»‡u báº¯t buá»™c")
                .oneOf([Yup.ref('newPassword'), null], 'Máº­t kháº©u má»›i pháº£i trÃ¹ng khá»›p')
        }),
    ...
    return (
        <div className="">
            ...
            <form className="grid grid-cols-2 gap-4" onSubmit={formik.handleSubmit}>
                <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Máº­t kháº©u cÅ©</label>
                    <input
                        type="password"
                        name="oldPassword"
                ...
                <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Máº­t kháº©u má»›i</label>
                    <input
                        type="password"
                        name="newPassword"
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
