...
export default function BillDetailPage() {
    ...
    return (
        <PageLayout title="Chi tiáº¿t Ä‘Æ¡n hÃ ng">
                            ...
                            <div className="my-2 p-5 bg-white">
                                ...
                                <div className="mt-12">
                                    <table className="w-full">
                                        <thead>
                                            <tr>
                                                <th className="text-left font-semibold">Sáº£n pháº©m</th>
                                                <th className="text-left font-semibold">ÄÆ¡n giÃ¡</th>
                                                <th className="text-left font-semibold">Sá»‘ lÆ°á»£ng</th>
                                ...
                                <div className="mt-8">
                                    <div className="flex justify-between">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="">
                                                <div className="inline-block text-sm font-bold text-gray-600">PhÆ°Æ¡ng thá»©c thanh toÃ¡n:</div>
