            ...
            <div>
              <div className="p-4 ">
                ...
                <div className=" font-poppins dark:text-gray-400">
                  ...
                  <h2 className="mb-4 text-xl font-semibold font-poppins dark:text-gray-300">
                    {details.title2}
                  </h2>
                  <p className="pb-4">{details.content2}</p>
                  <img className="pb-4" src={details.img2} />
                  <p className="pb-4">{details.content2v1}</p>
                  <p className="pb-4">{details.content2v2}</p>
                </div>
                ...
                <div className=" font-poppins dark:text-gray-400">
                  ...
                  <p className="pb-4">{details.content3}</p>
                  <img className="pb-4" src={details.img3} />
                  <p className="pb-4">{details.content3v1}</p>
                  <p className="pb-4">{details.content3v2}</p>
                </div>
                <div className=" font-poppins dark:text-gray-400">
                  <h2 className="mb-4 text-xl font-semibold font-poppins dark:text-gray-300">
                    {details.title4}
                  </h2>
                  <p className="pb-4">{details.content4}</p>
                  <img className="pb-4" src={details.img4} />
                  <p className="pb-4">{details.content4v1}</p>
                  <p className="pb-4">{details.content4v2}</p>
                </div>
                <div className=" font-poppins dark:text-gray-400">
                  <h2 className="mb-4 text-xl font-semibold font-poppins dark:text-gray-300">
                    {details.title5}
                  </h2>
                  <p className="pb-4">{details.content5}</p>
                  <img className="pb-4" src={details.img5} />
                  <p className="pb-4">{details.content5v1}</p>
                  <p className="pb-4">{details.content5v2}</p>
                </div>
                <div className=" font-poppins dark:text-gray-400">
                  <h2 className="mb-4 text-xl font-semibold font-poppins dark:text-gray-300">
                    {details.title6}
                  </h2>
                  <p className="pb-4">{details.content6}</p>
                  <img className="pb-4" src={details.img6} />
                  <p className="pb-4">{details.content6v1}</p>
                  <p className="pb-4">{details.content6v2}</p>
                </div>
              </div>
              <div className="px-4">
