...
function Information() {
    return (
        ...
        //                 <p>
        //
        //                 </p>                     Trong trường hợp Quý khách có bất kỳ thắc mắc nào liên quan đến Chính sách bảo mật này, Quý
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">CHÍNH SÁCH BẢO MẬT THÔNG TIN</h2>
                    <p class="mb-4 font-light text-[18px]">   Chính sách bảo mật thông tin (“Chính sách bảo mật” hoặc “Chính sách”) này bao gồm các quy
                        định liên quan đến việc thu thập, sử dụng, tiết lộ và/hoặc xử lý Thông Tin Khách Hàng (như
                        được định nghĩa bên dưới) mà Quý khách đã cung cấp cho Công ty CP TM dịch vụ trà cà phê CN
                        (“Công ty”) hoặc Công ty lưu giữ của Quý khách trong quá trình Quý khách đăng ký tài khoản,
                        mua hàng, sử dụng các sản phẩm và dịch vụ của Công ty (“Sản Phẩm - Dịch Vụ”), hoặc khi Quý
                    ...
                    <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">THÔNG TIN KHÁCH HÀNG</h2>
                    <p class="mb-4 font-light text-[18px]">Thông tin này bao gồm nhưng không giới hạn ở họ và tên, địa chỉ email, số điện thoại, địa
                        chỉ giao hàng, tài khoản ngân hàng và thông tin thanh toán, thông tin trên biểu mẫu, tờ
                        khai, đơn đăng ký, phiếu khảo sát, đơn phản hồi hoặc khiếu nại (dù trực tuyến hay bằng hình
                        thức khác), các thông tin được gửi bởi hoặc cung cấp thông qua các thiết bị được sử dụng để
                        truy cập vào WEBSITE, hoặc các thông tin mà Quý khách chủ động gửi đến cho Công ty.</p>

                    <p class="font-medium text-[20px]">Thông tin có được do sự tương tác của Quý khách với Công ty:</p>
                    <p class="mb-4 font-light text-[18px]"> Thông tin này bao gồm bất kỳ thông tin nào khác về Quý khách khi Quý khách trao đổi với Công
                        ty qua bất kỳ phương tiện nào (điện thoại, thư từ, fax, gặp gỡ trực tiếp, email, mạng xã
                        hội, các ứng dụng), đăng nhập và sử dụng Sản Phẩm - Dịch Vụ hoặc tương tác thông qua
                        WEBSITE, kể cả việc Quý khách đã sử dụng như thế nào.</p>

                    <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">SỰ CHẤP THUẬN CỦA KHÁCH HÀNG</h2>

                    <p class="mb-4 font-light text-[18px]"> Khi sử dụng Sản Phẩm - Dịch Vụ và/hoặc tương tác với Công ty, Quý khách xác nhận và đồng ý
                        rằng Quý khách chấp nhận các quy định của Chính sách bảo mật này, và Quý khách đồng ý cho
                        Công ty thu thập, sử dụng, tiết lộ và/hoặc xử lý Thông Tin Khách Hàng theo quy định mô tả
                        trong đây. TRONG TRƯỜNG HỢP QUÝ KHÁCH KHÔNG ĐỒNG Ý VỚI CHÍNH SÁCH BẢO MẬT NÀY, QUÝ KHÁCH CÓ
                        THỂ CÂN NHẮC DỪNG CUNG CẤP THÔNG TIN KHÁCH HÀNG CHO CÔNG TY; TỰ ĐĂNG NHẬP TÀI KHOẢN ĐỂ KIỂM
                    ...
                    <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">MỤC ĐÍCH SỬ DỤNG THÔNG TIN</h2>
                    <p class="mb-4 font-light text-[18px]"> Thông Tin Khách Hàng chỉ được Công ty sử dụng cho một hoặc tất cả các mục đích (“Mục Đích”)
                        sau đây: Xử lý đơn đặt hàng và cung cấp Sản Phẩm - Dịch Vụ cho Quý khách; Cung cấp thông
                        tin, chính sách, tiến độ mua bán liên quan đến Sản Phẩm - Dịch Vụ; hỗ trợ khi Quý khách có
                        yêu cầu Xác nhận và thực hiện các giao dịch tài chính liên quan đến các khoản thanh toán
                        trực tuyến của Quý khách khi Quý khách sử dụng Sản Phẩm - Dịch Vụ; Gửi thông tin sản phẩm,
                        ...
                        chấp, khiếu nại liên quan; Ngăn ngừa các hoạt động phá hủy tài khoản của Quý khách hoặc giả
                        mạo Quý khách; Theo yêu cầu của cơ quan nhà nước có thẩm quyền hoặc theo quy định của pháp
                        luật vào từng thời điểm.</p>

                    <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">ĐỐI TƯỢNG TIẾP CẬN THÔNG TIN KHÁCH HÀNG</h2>
                    <p class="mb-4 font-light text-[18px]"> Trừ trường hợp pháp luật Việt Nam có quy định khác, chỉ những đối tượng dưới đây mới được
                        tiếp cận Thông Tin Khách Hàng:</p>
                    <p class="mb-4 font-light text-[18px]"> Cơ quan nhà nước có thẩm quyền như Viện kiểm sát, tòa án, cơ quan công an điều tra, khi có
                        yêu cầu cụ thể theo quy định của pháp luật Việt Nam;</p>
                    <p class="mb-4 font-light text-[18px]"> Ngân hàng hoặc các Tổ chức thẻ Visa/Mastercard liên quan đến hành vi vi phạm pháp luật hoặc
                        gian lận thẻ tín dụng liên quan đến Khách hàng</p>
                    <p class="mb-4 font-light text-[18px]">Công ty, công ty mẹ, công ty con, công ty liên kết của Công ty, đại lý, nhà thầu, đơn vị
                        ...
                        <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">THỜI GIAN LƯU TRỮ</h2>
                    <p class="mb-4 font-light text-[18px]"> Thông Tin Khách Hàng được lưu trữ cho đến khi Quý khách có yêu cầu Công ty hủy bỏ, hoặc Quý
                             khách tự đăng nhập và hủy bỏ thông tin. Trong mọi trường hợp, Thông Tin Khách Hàng được lưu
                             trữ và bảo mật trên máy chủ của Công ty.</p>

                             <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">THÔNG TIN LIÊN HỆ CỦA CÔNG TY</h2>
                             <p class="mb-4 font-light text-[18px]">Trong trường hợp Quý khách có bất kỳ thắc mắc nào liên quan đến Chính sách bảo mật này, Quý
                             khách có thể liên hệ Công ty theo thông tin dưới đây:</p>
                             <p class="mb-4 font-light text-[18px]">Công ty cổ phần thương mại dịch vụ trà cà phê VN</p>
                             <p class="mb-4 font-light text-[18px]"> Địa chỉ: Tầng 3,4 Toà nhà The Hub 195/10E Điện Biên Phủ, Phường 15, Quận Bình Thạnh, TP Hồ
                             Chí Minh</p>
                             <p class="mb-4 font-light text-[18px]">Email: gabi_store@gmail.com</p>
                             <p class="mb-4 font-light text-[18px]">Hotline: 028.71.087.088</p>

                             <h2 class="mb-4 text-[20px] tracking-tight font-bold text-gray-900 dark:text-white">HIỆU LỰC</h2>
                             <p class="mb-4 font-light text-[18px]">Chính sách bảo mật này có hiệu lực kể từ ngày 20/09/2023.</p>
                </div>
            </div>
        </section>
    );
