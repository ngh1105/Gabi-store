                ...
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    ...
                    <div className="mr-auto place-self-center lg:col-span-7">
                        <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white uppercase">
                            E-Shop - thá»i trang cháº¥t lÆ°á»£ng
                        </h1>
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                            Sáº£n pháº©m E-Shop Ä‘Æ°á»£c sáº£n xuáº¥t vÃ  chá»n lá»c kÄ© cÃ ng Ä‘á»ƒ Ä‘em ra
                            nhá»¯ng Ä‘áº§u ra cháº¥t lÆ°á»£ng nháº¥t Ä‘á»ƒ lÃ m hÃ i lÃ²ng khÃ¡ch hÃ ng.
                        </p>
