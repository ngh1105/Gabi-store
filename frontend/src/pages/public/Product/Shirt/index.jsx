  ...
  return (
    ...
    <div className="">
      ...
      <img
        ...
        src={
          "https://file.hstatic.net/1000184601/file/z4345686899656_98cd84d1592737be9ea88fe907f38b0e_3b35c0c6f3f64e98b4b6fca043ecca50.jpg"
        }
        ...
        <div className="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
          ...
          <div className="flex flex-wrap mb-24 -mx-3 ">
            ...
            <div className="w-full px-3 lg:w-3/4 ">
              ...
              <h1 className="text-[30px] my-[20px] font-semibold">Áo thun</h1>
