...
function Polo() {
  return (
    ...
    <div className="">
      {/* Banner */}
      <img className="h-[700px] object-cover  w-[100%] rounded-lg" src={'//theme.hstatic.net/200000053174/1001115888/14/home_category_image_2.jpg?v=1352'} alt="image description" />
        ...
        <div className="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
          ...
          <div className="flex flex-wrap mb-24 -mx-3 ">
            ...
            <div className="w-full px-3 lg:w-3/4 ">
              ...
              <h1 className="text-[30px] my-[20px] font-semibold">Áo Polo</h1>
