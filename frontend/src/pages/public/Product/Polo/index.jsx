...
function Polo() {
  return (
    ...
    <div className="">
      {/* Banner */}
      <img className="h-[300px] object-cover  w-[100%] rounded-lg" src={'//theme.hstatic.net/200000053174/1001115888/14/home_category_image_2.jpg?v=1352'} alt="image description" />
