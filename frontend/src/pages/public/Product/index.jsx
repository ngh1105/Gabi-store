                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div className="flex items-center">
                                    ...
                                    <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 hover:text-indigo-600">Sáº£n pháº©m</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                                ...
                                <div className=" items-center justify-between hidden px-4 py-2 mb-4 bg-gray-100 md:flex dark:bg-gray-900 ">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <select
                                            ...
                                            <option value="mostPopular">Phá»• biáº¿n nháº¥t</option>
                                            <option value="lowestPrice">GiÃ¡ tháº¥p nháº¥t</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
