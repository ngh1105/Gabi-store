...
export default function ContactPage() {
    return (
        <PageLayout title="LiÃªn há»‡">
            <PageTitle name="LiÃªn há»‡" imageUrl={`${API_URL}${"/upload/page/contact.avif"}`} />
            <div>
                <div className="container flex flex-col mx-auto bg-white">
                    <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                        <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                            ...
                            <p className="text-base leading-7 text-dark-grey-600">LiÃªn há»‡ chÃºng tÃ´i qua</p>
                        ...
                        <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                            ...
                            <p className="text-2xl font-extrabold text-dark-grey-900">Sá»‘ Ä‘iá»‡n thoáº¡i</p>
                            <p className="text-base leading-7 text-dark-grey-600">HÃ£y liÃªn há»‡ vá»›i chÃºng tÃ´i qua Ä‘iá»‡n thoáº¡i</p>
                            <a className="text-lg font-bold text-purple-blue-500" href="tel:+516-486-5135">+84 0123 3700</a>
                        </div>
                        <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width={38} height={38} viewBox="0 0 38 38" fill="none">
                            ...
                            <p className="text-2xl font-extrabold text-dark-grey-900">Äá»‹a Ä‘iá»ƒm</p>
                            <p className="text-base leading-7 text-dark-grey-600">TÃ¬m chÃºng tÃ´i táº¡i vÄƒn phÃ²ng cá»§a chÃºng tÃ´i</p>
                            <a className="text-lg font-bold text-purple-blue-500" target="_blank" href="https://goo.gl/maps/QcWzYETAh4FS3KTD7">QSQT Q.GÃ² Váº¥p TP.HCM</a>
                        </div>
                    </div>
                </div>
                <section>
                    <div className="py-12 md:px-12">
                        <div className="container w- mx-auto xl:px-32">
                            <div className="grid items-center lg:grid-cols-2">
                                <div className="">
                                    <div className="pr-10">
                                        <h2 className="mb-7 text-3xl font-bold">LiÃªn há»‡ vá»›i chÃºng tÃ´i</h2>
                                        <form action="https://formbold.com/s/FORM_ID" method="POST">
                                            <div className="mb-3">
                                                <label htmlFor="name" className="mb-3 block text-base font-medium text-[#07074D]">
                                                    Há» vÃ  tÃªn
                                                </label>
                                                <input type="text" name="name" id="name" placeholder="TÃªn Ä‘áº§y Ä‘á»§" className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-4 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                            </div>
                                            <div className="mb-3">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <textarea rows={2} name="message" id="message" placeholder="Lá»i nháº¯n cá»§a báº¡n..." className="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-4 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" defaultValue={""} />
                                            </div>
                                            <div>
