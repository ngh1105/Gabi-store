    ...
    return (
        ...
        <div class="">
            {/* <div class="">
                <div class="w-full px-4">
                    <div class="mx-auto text-center ">
                        <h2
                            class="mb-4 text-3xl font-medium text-dark sm:text-4xl md:text-[40px] dark:text-white"
                        >
                            LIÊN HỆ
                        </h2>
                        <p class="text-base text-body-color dark:text-dark-6">
                           Gửi tin nhắn cho GABISTORE
            ...
            {/* <div class="relative bg-indigo-800">
                ...
                <div class="relative max-w-7xl mx-auto sm:py-20 ">
                    <h1 class="text-4xl font-extrabold  text-white sm:text-5xl lg:text-6xl">LIÊN HỆ
                    </h1>
                </div>
            ...
            <div class="container flex flex-col mx-auto bg-white">
                ...
                <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                    <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                        ...
                        <p class="text-base leading-7 text-dark-grey-600">Liên hệ chúng tôi qua</p>
                        <a class="text-lg font-bold text-purple-blue-500" href="mailto: hello@loopple.com">Gabistore@gmail.com</a>
                    </div>
                    <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                        ...
                        <p class="text-base leading-7 text-dark-grey-600">Hãy liên hệ với chúng tôi qua điện thoại</p>
                        <a class="text-lg font-bold text-purple-blue-500" href="tel:+516-486-5135">+84 0123 3700</a>
                    </div>
                    <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                        ...
                        <p class="text-base leading-7 text-dark-grey-600">Tìm chúng tôi tại văn phòng của chúng tôi</p>
                        <a class="text-lg font-bold text-purple-blue-500" target="_blank" href="https://goo.gl/maps/QcWzYETAh4FS3KTD7">QSQT Q.Gò Vấp TP.HCM</a>
                    </div>
                </div>
