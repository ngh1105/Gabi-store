                ...
                <div className="container flex flex-col mx-auto bg-white">
                    <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                            ...
                            <p className="text-2xl font-extrabold text-dark-grey-900">Số điện thoại</p>
                            <p className="text-base leading-7 text-dark-grey-600">Hãy liên hệ với chúng tôi qua điện thoại</p>
                        ...
                        <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                            ...
                            <p className="text-2xl font-extrabold text-dark-grey-900">Địa điểm</p>
                            <p className="text-base leading-7 text-dark-grey-600">Tìm chúng tôi tại văn phòng của chúng tôi</p>
                            <a className="text-lg font-bold text-purple-blue-500" target="_blank" href="https://goo.gl/maps/QcWzYETAh4FS3KTD7">QSQT Q.Gò Vấp TP.HCM</a>
                        </div>
                    </div>
                </div>
                <section className>
