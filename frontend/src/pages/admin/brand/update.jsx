...
export default function UpdatePage({ id, fetchData }) {
    ...
    const updateData = async () => {
        ...
        setImageFromUrl(utils.resolveImage(res.response.imageUrl));
    }
    ...
    const uploadImage = async (id) => {
        ...
        const resData = await Api.Post(`/brand/upload-image/${id}`, formData, {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            const resData = await Api.Patch(`/brand/${id}`, data);
            if (!resData.isSuccess) {
                setStatus(prevState => ({
                    isError: true,
