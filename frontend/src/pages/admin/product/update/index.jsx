export default function UpdateProductsPage() {
    return (
        <>
            ...
            {/* Modal toggle */}
            <div className="flex">
                <button id="updateProductButton" data-modal-toggle="updateProductModal" className="block text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-2 py-2 text-center " type="button">
                 Sửa
                </button>
            </div>
            {/* Main modal */}
  ...
  <div className="grid gap-4 mb-4 sm:grid-cols-2">
    <div>
      <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 left-0">Tên loại hàng</label>
      <input type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Tên sản phẩm" required />
    </div>
    <div>
