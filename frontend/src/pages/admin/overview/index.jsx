            ...
            <section className="px-4 pt-6">
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="p-6 mb-8 bg-white rounded shadow lg:mb-0 dark:bg-gray-900">
                        ...
                        <div className="flex items-center justify-between mb-3">
                            <h2 className="font-medium text-gray-500 dark:text-gray-400">Sáº£n pháº©m</h2>
                            <span className=""></span>
                        </div>
                        <div className="relative w-full h-1 mb-2 bg-gray-200 rounded">
                                ...
                                recentBills.map((obj, index) => {
                                    return (
                                        <div key={index} className="flex justify-between mb-4">
                                            ...
                                            <div className><span className="font-medium text-indigo-600">Sá»‘ lÆ°á»£ng: {obj.quantity}</span></div>
                                        </div>
                                    )
                                })
                            }
